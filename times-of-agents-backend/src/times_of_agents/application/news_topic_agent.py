...
from times_of_agents.infrastructure.trending_news import (
    NewsArticle,
    fetch_trending_news,
...
def generate_topics_from_trending_news(
    *,
...
) -> tuple[list[dict[str, Any]], TokenUsageSummary]:
    if article_count <= 0:
    ...
    collector_agent = Agent(
        ...
        max_iter=2,
        step_callback=make_step_callback("News Curator"),
    )
    ...
    return generated_topics, usage_summary
...
def _generate_search_summaries(
    ...
    *,
    ...
    researcher_agent = Agent(
        ...
        allow_delegation=False,
        max_iter=2,
        step_callback=make_step_callback("News Researcher"),
    )
